...
public class PanelRedondeado2 extends JPanel {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        // Dibujar la línea negra delgada en la parte inferior
        g2.setColor(java.awt.Color.BLACK);
        g2.drawLine(0, getHeight() - 1, getWidth(), getHeight() - 1); // Línea horizontal en la parte inferior
